                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-accent/10 rounded-lg p-4">
                      ...
                      <div className="mb-4">
                        <Label className="text-sm font-medium mb-2 block text-right">
                          اختر الولاية لحساب رسوم التوصيل:
                        </Label>
                        <Select
                        ...
                        >
                          ...
                          <SelectContent>
                            {Object.entries(wilayaDeliveryPrices).map(
                              ([wilaya, price]) => (
                                <SelectItem
                                  key={wilaya}
                                  value={wilaya}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="wilaya" className="text-right block">
                            الولاية *
                          </Label>
                          <Select
                            value={customerInfo.wilaya}
                            onValueChange={(value) =>
                              updateCustomerInfo("wilaya", value)
                            }
                            dir="rtl"
                            required
                          >
