...
const Checkout = () => {
    ...
    const urlCheckoutData = encodedData
        ? decodeCheckoutData(encodedData)
        : null;
    ...
    const handleSubmit = async e => {
        ...
        try {
            ...
            const [orderResponse, response, responseCode, error] =
            ...
            if (responseCode === 201 && orderResponse?.success) {
                ...
                if (orderResponse && orderResponse.error) {
                    ...
                    console.log(
                        'Error from response.data.error:',
                        errorMessage
                    );
                } else if (error) {
                    if (typeof error === 'string') {
                        ...
                        console.log(
                            'Error from error.response.data.error:',
                            errorMessage
                        );
                        ...
                        console.log(
                            'Error from error.response.data.message:',
                            errorMessage
                        );
