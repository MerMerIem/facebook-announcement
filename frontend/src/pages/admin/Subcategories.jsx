...
export default function Subcategories() {
    ...
    const fetchData = async (page = 1, search = '') => {
        ...
        try {
            ...
            const [catsData, __, catsCode, catsError] =
            ...
            if (
                ...
                setPagination(
                    subcatsData.pagination || { totalPages: 1, totalItems: 0 }
                );
            } else {
                throw new Error(
                    subcatsError || catsError || 'Failed to fetch data'
                );
            }
        } catch (err) {
    ...
    return (
        <div className="space-y-6" dir="rtl">
            ...
            <Card>
                <CardHeader>
                    <CardTitle>
                        قائمة الفئات الفرعية ({pagination.total || 0})
                    </CardTitle>
                </CardHeader>
                                                    ...
                                                    >
                                                        <DialogTrigger asChild>
                                                            <Button
                                                                variant="outline"
                                                                size="sm"
                                                                className="border-primary text-primary bg-white/95 hover:bg-primary hover:text-accent focus-visible:border-primary/50 focus-visible:ring-primary/30"
                                                                onClick={() => {
                                                                    setEditingSubcategory(
                                                                        subcategory
                                                                    );
