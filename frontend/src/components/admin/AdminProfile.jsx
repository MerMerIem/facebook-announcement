    ...
    return (
        <div className="min-h-screen bg-background p-3 sm:p-4 md:p-6" dir="rtl">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-6 sm:mb-8">
                    <h1 className="text-2xl sm:text-3xl font-bold text-right mb-2">
                        حسابي
                    </h1>
                </div>
                    ...
                    <CardContent className="p-4 sm:p-6">
                        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-3 sm:gap-4 text-center sm:text-right">
                            ...
                            <div className="flex-1">
                                ...
                                <p
                                    className="text-sm sm:text-base text-muted-foreground break-all"
                                    dir="ltr"
                                >
                                    {user.email}
                                </p>
                    ...
                    <CardContent className="p-4 sm:p-6">
                        ...
                        >
                            ...
                            <div className="space-y-2">
                                ...
                                {passwordError && (
                                    <p className="text-xs sm:text-sm text-destructive text-right leading-relaxed">
                                        {passwordError}
                                    </p>
                                )}
                            </div>
