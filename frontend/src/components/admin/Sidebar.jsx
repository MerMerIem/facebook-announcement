                ...
                {menuItems.map(item => {
                        ...
                        return (
                            <div key={item.title}>
                                <button
                                    ...
                                    className={cn(
                                        'w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sidebar-foreground hover:bg-sidebar-accent/20 transition-colors',
                                        hasActiveChild &&
                                    ...
                                    <div className="mt-1 space-y-1">
                                        {item.children.map(child => (
                                            <Link
                                                ...
                                                to={child.href}
                                                className={cn(
                                                    'block px-3 py-2 mr-6 rounded-lg text-sidebar-foreground/80 hover:bg-sidebar-accent/20 transition-colors text-right',
                                                    isActive(child.href) &&
                                                        'font-semibold shadow-sm'
                                                )}
                                                style={
                    ...
                    return (
                        <Link
                            ...
                            to={item.href}
                            className={cn(
                                'flex items-center gap-3 px-3 py-2 rounded-lg text-sidebar-foreground hover:bg-sidebar-accent/20 transition-colors',
