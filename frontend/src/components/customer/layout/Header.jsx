...
const Header = ({ onSearch, searchQuery = '' }) => {
    ...
    return (
        <header
            className="bg-white border-b border-border backdrop:blur-sm sticky top-0 z-50 box-shadow-elegant py-2"
            dir="rtl"
        >
                        ...
                        <Link to="/cart">
                            ...
                            >
                                ...
                                {itemCount > 0 && (
                                    <Badge
                                        variant="destructive"
                                        className="absolute -top-2 -right-2 h-5 w-5 rounded-md bg-red-600! p-0 flex items-center justify-center text-xs"
                                    >
                                        {itemCount}
                                    </Badge>
                                )}
                        ...
                        <form onSubmit={handleSearch} className="w-full">
                            <div className="relative">
                                <Input
                                    ...
                                    className="pr-12 h-12 rounded-md"
                                />
                                <Button
                                    type="submit"
                                    size="sm"
