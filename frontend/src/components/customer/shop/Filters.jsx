...
const Filters = ({
  ...
  return (
    <Card className="animate-slide-up border-none">
      ...
      <CardContent className="space-y-6">
        ...
        >
          <CollapsibleTrigger asChild>
            ...
            >
              <span className="font-bold text-primary">الفئات</span>
              <ChevronDown
          ...
          >
            <CollapsibleTrigger asChild>
              <Button
                ...
                className="w-full justify-between p-0 h-auto"
              >
                <span className="font-bold text-primary">الفئات الفرعية</span>
                <ChevronDown
                  className={`h-4 w-4 transition-transform ${
          ...
          >
            <CollapsibleTrigger asChild>
              <Button
                ...
                className="w-full justify-between p-0 h-auto"
              >
                <span className="font-bold text-primary">الوسوم</span>
                <ChevronDown
                  className={`h-4 w-4 transition-transform ${
        ...
        >
          <CollapsibleTrigger asChild>
            <Button
              ...
              className="w-full justify-between p-0 h-auto"
            >
              <span className="font-bold text-primary">العروض</span>
              <ChevronDown
                className={`h-4 w-4 transition-transform ${
